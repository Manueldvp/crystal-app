        ...
        <div className="flex justify-end">
          <div className="flex space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Link href='/core-restore'
              type="button"
              className={`text-white  bg-aquamarine-blue-300 hover:bg-fuchsia-pink-400 focus:ring-4 focus:outline-none  font-medium rounded-full text-sm px-4 ${isDesktop ? 'mr-4' : ''} py-2 text-center`}
            >
              Core Restore
            </Link>
            <button
