      ...
      <div className="mx-auto w-full  px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <div className="">
            <Image
              ...
              height={400}
              width={400}
              className={`${isDesktop ? "absolute mt-5" : "relative mb-10"} `}
            />
          </div>
        ...
        <div className="mt-10 mb-[-30px]">
          {isDesktop ? (
            <Link
              ...
              className="flex w-full font-light text-sm items-center justify-between "
            >
            ...
            <Link
              href="https://maps.app.goo.gl/5317ZztLRFisfYZ76"
              className="flex w-full font-lightm mt-1 text-xs items-center justify-between "
            >
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            ...
            <Link className="ml-4" href="/politica-de-cookies">
              {" "}
              Política de Cookies
            </Link>
          </Typography>
