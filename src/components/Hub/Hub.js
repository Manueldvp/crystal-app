        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <RevealWrapper>
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-4">
                Fisioterapia Pélvica Especializada: Cuida tu Piso Pélvico en
                Cada Etapa
              </h1>
              <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-lg mx-auto lg:mx-0">
                Atención experta en fisioterapia pélvica para embarazo,
                postparto, dolor pélvico, endometriosis y salud sexual. Cuida tu
                piso pélvico con especialistas en Puebla.
              </p>
              ...
              <div className="mt-8 flex items-center gap-3 justify-center lg:justify-start">
                ...
                <p className="text-sm text-gray-600">
                  <strong className="text-gray-900">+500</strong> pacientes
                  atendidas
                </p>
              </div>
            </div>
          ...
          <RevealWrapper>
            <div className="relative order-1 lg:order-2">
              <div className="relative w-full max-w-md lg:max-w-lg mx-auto aspect-[3/4] max-h-[500px] lg:max-h-[650px] rounded-3xl overflow-hidden shadow-xl">
                <Image
              ...
              {/* Floating card */}
              <div className="absolute bottom-6 left-6 lg:bottom-10 lg:left-8 bg-white rounded-2xl shadow-2xl p-4 w-[200px] transform rotate-[4deg] hover:rotate-0 transition-transform duration-300 z-10">
