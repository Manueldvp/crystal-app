...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Fisioterapeuta especializada en Uroginecología y Sexualidad Funcional. Tratamiento de dolor pélvico, endometriosis, incontinencia y más.',
    images: [
      {
        url: '/43.png',
        width: 1200,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: 'Torres Médicas Angelópolis II, Piso 4, Consultorio 408',
