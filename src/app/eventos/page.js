    ...
    <>
      ...
      <div className="2xl:mx-auto 2xl:container  lg:px-40 xl:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex flex-col items-center justify-center">
          ...
          ¡Descubre, aprende y crece con nuestros talleres!

            ¿Estás buscando una forma de expandir tus habilidades, explorar nuevas pasiones o simplemente pasar un buen rato? ¡Nuestros talleres son la solución perfecta! Ofrecemos una variedad de talleres diseñados para todos los niveles de experiencia y en una amplia gama de temas.
          </p>
        </div>
