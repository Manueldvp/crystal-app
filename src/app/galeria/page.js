        ...
        <div className="pt-32 lg:flex items-center relative z-10 container mx-auto">
          ...
          <div role="contentinfo" className="w-full lg:w-1/2 h-full">
            ...
            <p  className="text-gray-800 font-regular mb-8">
              ...
              triunfo en el camino de la recuperación de nuestros pacientes,
              esperamos que estas imágenes te inspiren confianza en nuestra
              dedicación a tu bienestar. ¡Disfruta del recorrido!
            </p>
            <Link href="/about">
