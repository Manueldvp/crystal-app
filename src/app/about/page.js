            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-5">
                  Mi trabajo como fisioterapeuta nace precisamente de ese vacío: <strong className="text-gray-800">acompañar, informar y tratar aquello que durante años ha sido normalizado como "parte de la vida".</strong>
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="p-6 bg-gradient-to-r from-purple-secondary-50 to-pink-secondary-50 rounded-xl border border-purple-secondary-100">
                <p className="text-lg text-gray-700 text-center">
                  "La fisioterapia pélvica no solo trata músculos, <strong className="text-fuchsia-pink-600">trata personas</strong>."
                </p>
              </div>
            </div>
          </RevealWrapper>
